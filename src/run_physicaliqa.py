...
class PhysicaliqaDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        goal_tokens = self.tokenizer.tokenize(example["goal"])
        solutions_tokens = [self.tokenizer.tokenize(s_) for s_ in example["solutions"]]
        ...
        for choice_idx, solution_tokens in enumerate(solutions_tokens):
            ...
            for goal_token in goal_tokens:
                choice_tokens.append(goal_token)
                choice_segment_ids.append(0)
